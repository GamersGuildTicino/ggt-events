const enGB = {
  ...
  "error.memberships.fetch_one": "Unable to load the membership.",
  ...
  "error.memberships.parse_one": "The membership data is invalid.",
  "error.memberships.update": "Unable to update the membership.",

  "error.membership_payments.create": "Unable to add the payment.",
  "error.membership_payments.delete": "Unable to delete the payment.",
  "error.membership_payments.fetch_many": "Unable to load payments.",
  "error.membership_payments.invalid_amount": "Please enter a valid amount.",
  "error.membership_payments.invalid_date": "Please enter a valid date.",
  "error.membership_payments.invalid_method": "Please choose a payment method.",
  "error.membership_payments.parse_many": "Payments data is invalid.",
  ...
  "page.admin_memberships.form.create": "Add",
  ...
  "page.admin_membership.payments.amount": "Amount",
  "page.admin_membership.payments.cancel": "Cancel",
  "page.admin_membership.payments.create": "Add payment",
  "page.admin_membership.payments.create_heading": "Add payment",
  "page.admin_membership.payments.created": "Payment added.",
  "page.admin_membership.payments.date": "Date",
  "page.admin_membership.payments.delete": "Delete payment",
  "page.admin_membership.payments.delete.confirm":
    "Delete this payment? This cannot be undone.",
  "page.admin_membership.payments.deleted": "Payment deleted.",
  "page.admin_membership.payments.edit": "Edit payment",
  "page.admin_membership.payments.edit_heading": "Edit payment",
  "page.admin_membership.payments.empty": "No payments yet.",
  "page.admin_membership.payments.heading": "Payments",
  "page.admin_membership.payments.method": "Method",
  "page.admin_membership.payments.save": "Save changes",
  "page.admin_membership.payments.time": "Time",
  "page.admin_membership.payments.updated": "Payment updated.",
