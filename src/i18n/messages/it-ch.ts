const itCH = {
  ...
  "enum.membership_payment_method.bank_transfer": "Bonifico",
  ...
  "error.memberships.create": "Impossibile completare il tesseramento.",
  "error.memberships.delete": "Impossibile eliminare il tesseramento.",
  ...
  "page.admin.memberships.description":
    "Visualizza, aggiungi, modifica e rimuovi i tesserati dell'associazione.",
  "page.admin.memberships.heading": "Tesserati",
  "page.admin.memberships.open": "Apri tesserati",
  ...
  "page.admin_memberships.form.first_name": "Nome",
  "page.admin_memberships.form.last_name": "Cognome",
  "page.admin_memberships.form.newsletter": "Newsletter accettata",
  "page.admin_memberships.form.payment_method": "Metodo di pagamento",
  "page.admin_memberships.form.phone_number": "Numero di telefono",
  "page.admin_memberships.form.postal_code": "CAP",
  "page.admin_memberships.form.save": "Salva modifiche",
  "page.admin_memberships.form.street": "Via e numero",
  ...
  "page.admin_memberships.table.city": "Città",
  ...
  "page.admin_memberships.table.postal_code": "CAP",
  "page.admin_memberships.table.street": "Indirizzo",
...
`,
  ...
  "page.home.actions.donation.title": "Sostienici",
  "page.home.actions.membership.cta": "Diventa Membro",
  ...
  "page.home.events.contacts_join_cta": "Iscriviti",
  ...
  "page.membership.form.first_name": "Nome",
  "page.membership.form.first_name.placeholder": "Mario",
  "page.membership.form.heading": "I tuoi dati",
  "page.membership.form.last_name": "Cognome",
  "page.membership.form.last_name.placeholder": "Rossi",
  ...
  "page.membership.form.postal_code": "CAP",
  "page.membership.form.postal_code.placeholder": "6900",
  "page.membership.form.street": "Via e numero",
