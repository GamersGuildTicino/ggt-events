const itCH = {
  ...
  "error.memberships.invalid_home_address": "Inserisci un indirizzo di casa.",
  ...
  "page.admin_memberships.form.full_name": "Nome e cognome",
  "page.admin_memberships.form.home_address": "Indirizzo di casa",
