...
export const eventSchema = z.object({
  ...
  registrationsOpenAt: z.date(),
  shortDescription: z.string(),
  slug: z.string(),
  tablesPublished: z.boolean(),
  title: z.string(),
  updatedAt: z.date(),
...
export const eventRowSchema = z.object({
  ...
  registrations_open_at: z.string(),
  short_description: z.string(),
  slug: z.string(),
  tables_published: z.boolean(),
  title: z.string(),
  updated_at: z.string(),
  visibility: eventVisibilitySchema,
});
...
export const eventFromRowSchema = eventRowSchema.transform(
  (row): Event => ({
    ...
    registrationsOpenAt: new Date(row.registrations_open_at),
    shortDescription: row.short_description,
    slug: row.slug,
    tablesPublished: row.tables_published,
    title: row.title,
...
export const eventToRowSchema = eventSchema.transform(
  (event): EventRow => ({
    ...
    registrations_open_at: event.registrationsOpenAt.toISOString(),
    short_description: event.shortDescription,
    slug: event.slug,
    tables_published: event.tablesPublished,
    title: event.title,
