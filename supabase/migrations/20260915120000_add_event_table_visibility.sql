...
drop policy "everyone can view tables for non private events" on public.event_tables;
...
drop function public.fetch_public_event_tables(uuid);
...
grant execute on function public.fetch_public_event_tables(uuid) to anon, authenticated;
