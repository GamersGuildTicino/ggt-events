alter table "public"."event_registrations" drop constraint "event_registrations_table_email_unique";

drop index if exists "public"."event_registrations_table_email_unique";

CREATE UNIQUE INDEX event_registrations_table_email_player_name_unique ON public.event_registrations USING btree (event_table_id, email, player_name);

alter table "public"."event_registrations" add constraint "event_registrations_table_email_player_name_unique" UNIQUE using index "event_registrations_table_email_player_name_unique";
